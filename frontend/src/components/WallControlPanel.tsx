        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className={`fixed ${isMobile ? 'left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[75vh] w-[calc(100vw-2rem)] max-w-[360px]' : 'top-[15vh] left-1/2 -translate-x-1/2 max-h-[75vh] w-[90vw] max-w-[500px]'} z-[60] rounded-2xl ${isMobile ? 'p-4 overflow-y-auto' : 'p-8 overflow-y-auto'} shadow-2xl bg-white border-2 border-gray-200`}
              onClick={(e) => {
                e.stopPropagation();
                e.preventDefault();
              }}
