      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed ${isMobile ? 'top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[85vh] w-[90vw] max-w-[450px]' : 'top-[15vh] left-1/2 -translate-x-1/2 max-h-[75vh] w-[90vw] max-w-[600px]'} z-[60] rounded-3xl ${isMobile ? '' : ''} ${isMobile ? 'p-6 overflow-y-auto' : 'p-8 overflow-y-auto'} shadow-2xl bg-white border-2 border-gray-200`}
            onClick={(e) => {
              e.stopPropagation();
              e.preventDefault();
            }}
