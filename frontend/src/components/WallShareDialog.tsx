      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed ${isMobile ? 'inset-x-4 top-1/2 -translate-y-1/2 max-h-[75vh] w-auto max-w-[calc(100vw-2rem)]' : 'top-[15vh] left-1/2 -translate-x-1/2 max-h-[75vh] w-[90vw] max-w-[600px]'} z-[60] rounded-2xl ${isMobile ? 'mx-auto' : ''} ${isMobile ? 'p-4 overflow-y-auto' : 'p-8 overflow-y-auto'} shadow-2xl bg-white border-2 border-gray-200`}
            onClick={(e) => {
              e.stopPropagation();
              e.preventDefault();
            }}
